<template>
    <div class="list-item">
        <!-- <text class="title">{{formatTitle(data.h_title)}}</text> -->
        <text class="title" v-html="data.title"></text>
        <div class="item-image">
            <!-- <image class="image" v-for="img in data.image" :src="formatImage(img)"></image> -->
