<template>
  <div class="login-wapper">
    ...
    <div class="title">{{ isLogin ? '手机号登录' : '注册' }}</div>
    <div class="bg-wapper">
      <!-- 登录逻辑 -->
      ...
      <text class="button" @click="isLogin ? login() : register()">{{ isLogin ? '开始使用' : '注册' }}</text>

      <div class="more">
        <!--<text class="go-register" @click="tip">密码登录</text>-->
        <text class="go-register" @click="isLogin = !isLogin">{{ isLogin ? '手机号注册' : '已有账号？' }}</text>
